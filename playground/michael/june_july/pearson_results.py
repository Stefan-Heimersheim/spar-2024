...
folder = '../../artefacts/pearson'

file_basename = 'res_jb_sae_feature_correlation_pearson_X_Y_1M_0.1.npz'
...
plt.title('Percentage of Non-Zero Elements in Pearson Results by Layer Pair')
